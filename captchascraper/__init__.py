...
def get(url,headers=None,cookie=None,proxies=None,apikey):
      if proxies:
...
def post(url,data,headers=None,cookie=None,proxies=None,apikey):
      if proxies:
...
def put(url,headers=None,cookie=None,proxies=None,apikey):
      if proxies:
...
def patch(url,data,headers=None,cookie=None,proxies=None,apikey):
      if proxies:
...
def delete(url,headers=None,cookie=None,proxies=None,apikey):
      if proxies:
